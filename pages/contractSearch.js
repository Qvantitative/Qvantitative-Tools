...
export default function App() {
  ...
  const projectdata = 'https://api.looksrare.org/api/v1/collections/listing-rewards';
          ...
          <main className="flex-1">
            <div className="py-6">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-2xl font-semibold">Top 25 collections that can receive listing rewards on LooksRare</h1>
              </div>
                              ...
                              <table className="min-w-full divide-y divide-gray-200">
                                  <tbody>
                                    <tr>
                                      ...
                                      <th><strong>PRICE FLOOR</strong></th>
                                      <th><strong>24HR VOLUME</strong></th>
                                    </tr>
                                  </tbody>
                                  ...
                                  <tbody className="project" key={index}>
                                    <tr className={filterData % 4 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                      <td className="whitespace-nowrap text-sm font-medium text-gray-900">
                                        <img
                                            src={project.collection.imageURI}
                                            alt=""
                                        />
                                      </td>
                                      <td className="whitespace-nowrap text-sm font-medium text-gray-900">{project.collection.name}</td>
                                      <td className="whitespace-nowrap text-sm font-medium text-gray-900"> {floor} eth</td>
                                      <td className="whitespace-nowrap text-sm font-medium text-gray-900"> {volume24hr}</td>
                                    </tr>
                                  </tbody>
